...
const Header = () => {
   ...
   if(isLoading){
    return (
        <div className='fixed -mt-16 h-auto flex ml-12 w-full z-20 cursor-pointer skeleton'>
            <img src='https://www.instacart.com/image-server/120x24/www.instacart.com/assets/beetstrap/brand/2022/instacart-logo-color@3x-6b71df83cfba8c6827f59bff009df3be6e96d484ebdc5da7e6122e9555eae9b6.png' alt='app-name'
                className='mt-4 px-4 py-3 w-36 h-12 skeleton'
            />
            ...
            <div className="flex relative ml-16 mt-4 w-3/4">
                <input
                    ...
                    className='w-full h-7 decoration-slate-700 bg-white py-6 border-hidden rounded-lg font-semibold skeleton-text '
                />
            ...
            <div className='flex w-40 mt-4' onClick={toggleHidden} >
    ...
    return (<div>
        { !isLoading &&
        (<div className='fixed -mt-16 h-auto flex ml-12 w-full z-20 cursor-pointer bg-white'>
            <img src='https://www.instacart.com/image-server/120x24/www.instacart.com/assets/beetstrap/brand/2022/instacart-logo-color@3x-6b71df83cfba8c6827f59bff009df3be6e96d484ebdc5da7e6122e9555eae9b6.png' alt='app-name'
